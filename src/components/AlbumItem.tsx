        ...
        <div className="flex items-start gap-1">
          {explicit && (
            <svg
              ...
              className="w-5 shrink-0 items-start aspect-square fill-themed-text-muted"
            >
          ...
          <p
            className={`text-themed-text-muted text-nowrap ${variant === "small" ? "line-clamp-1" : "line-clamp-2"} leading-tight`}
            title={subtitle}
          >
